var serverURL = "http://ec2-54-201-87-182.us-west-2.compute.amazonaws.com/api/v1/node/3/";
...
$(document).ready(function(){
	...
	$.getJSON(serverURL, function (data) {
    	sensors.push(new sensor(data["location"]["latitude"],data["location"]["longitude"],data["location"]["name"]));
	});
